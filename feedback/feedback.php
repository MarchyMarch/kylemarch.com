...
$mailto = 'kcmarch23@gmail.com' ;
$subject = "Feedback Form kylemarch.com" ;
$formurl = "http://kylemarch.com/feedback/feedback.html" ;
$thankyouurl = "http://kylemarch.com/feedback/thanks.html" ;
$errorurl = "http://kylemarch.com/feedback/error.html" ;
$want_tel_field = 0;
$want_addr_field = 0;
...
$headers =
	"From: \"$fullname\" <$fromemail>" . $linesep . "To: \"$fullname\" <$email>" . $linesep . "X-Mailer: chfeedback.php 2.20.1" .
